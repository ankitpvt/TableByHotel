...
const AddMenu = () => {
    ...
    useEffect(() => {
        const fetchMenu = async () => {
            try {
                const response = await axios.get('https://tablebyhotel.onrender.com/api/menu');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://tablebyhotel.onrender.com/api/menu', newMenuItem);
    ...
    const deleteMenu = async (id) => {
        try {
            await axios.delete(`https://tablebyhotel.onrender.com/api/menu/${id}`);
